...
/*------------------ Visual Studio 2017 ----------------------*/
/*-----  Presionar L para visualizar otra posición de luz -----*/
...
glm::vec3 lightPos1(7.0f, 7.0f, 0.0f);
glm::vec3 lightPos2(-7.0f, -7.0f, 0.0f);
...
void display(void)
{
	...
	//Centro
	model = glm::rotate(model, glm::radians(sol), glm::vec3(1.0f, 1.0f, 1.0f));
	model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("specularColor", 0.0f, 1.0f, 1.0f);
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 0.7f, 0.8f);
	...
	//Tierra
	model = glm::rotate(model, glm::radians(tierra), glm::vec3(0.0f, 0.0f, 1.0f));
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 0.9f, 0.9f);
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 0.9f, 0.5f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	//Jupiter
	model = glm::rotate(model, glm::radians(jupiter), glm::vec3(0.0f, -1.0f, -1.0f));
	model = glm::translate(model, glm::vec3(6.0f, 0.0f, 0.0f));
	model = glm::rotate(model, glm::radians(jupiter), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 0.7f, 0.7f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	//Saturno
	model = glm::rotate(model, glm::radians(saturno), glm::vec3(-1.0f, 0.0f, -1.0f));
	model = glm::translate(model, glm::vec3(7.0f, 0.0f, 0.0f));
	model = glm::rotate(model, glm::radians(saturno), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 0.9f, 0.8f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	//Urano
	model = glm::rotate(model, glm::radians(urano), glm::vec3(1.0f, 1.0f, 1.0f));
	model = glm::translate(model, glm::vec3(8, 0, 0));
	model = glm::rotate(model, glm::radians(urano), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 0.7f, 0.9f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
