...
void display(void)
{
	...
	//Nucleo
	model = glm::rotate(model, glm::radians(nucleo), glm::vec3(1.0f, 1.0f, 1.0f));
	...
	//Particula A
	model = glm::rotate(model, glm::radians(particulaA), glm::vec3(1.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(3, 0, 0));
	model = glm::rotate(model, glm::radians(particulaA), glm::vec3(1.0f, 0.0f, 1.0f));
	model = glm::scale(model, glm::vec3(0.7f, 0.7f, 0.7f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.5f, 1.0f, 0.0f));
	sphere_draw();
	...
	//Particula B
	model = glm::rotate(model, glm::radians(particulaB), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::translate(model, glm::vec3(4, 0, 0));
	model = glm::rotate(model, glm::radians(particulaB), glm::vec3(1.0f, 0.0f, 1.0f));
	model = glm::scale(model, glm::vec3(0.7f, 0.7f, 0.7f));
	projectionShader.setMat4("model", model);
	...
	//Particula C
	model = glm::rotate(model, glm::radians(particulaC), glm::vec3(0.0f, 0.0f, 1.0f));
	...
	//Particula D
	model = glm::rotate(model, glm::radians(particulaD), glm::vec3(0.0f, 1.0f, 1.0f));
	...
	//Particula E
	model = glm::rotate(model, glm::radians(particulaE), glm::vec3(1.0f, 0.0f, 1.0f));
	...
	//Particula F
	model = glm::rotate(model, glm::radians(particulaF), glm::vec3(1.0f, 1.0f, 0.0f));
